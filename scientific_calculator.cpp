...
int main()
{
    ...
    cout << "*******Press 0 to quit the program*******\n"
         << endl;
    cout << "Enter 1 for Penambahan \n";
    cout << "Enter 2 for Pengurangan \n";
    cout << "Enter 3 for Perkalian \n";
    cout << "Enter 4 for Pembagian \n";
    cout << "Enter 5 for Pemangkatan \n";
    cout << "Enter 6 for Pemfaktoran \n";
    cout << "Enter 7 for Kuadrat \n";
    cout << "Enter 8 for Kubik \n";
    cout << "Enter 9 for Pengakaran\n\n";
    int choice;
    while (1)
    {
